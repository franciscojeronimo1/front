import { whatsappHref, whatsappPrefillMessages } from '../content/siteContent'

type PrefillKey = keyof typeof whatsappPrefillMessages

type WhatsAppButtonProps = {
  children: React.ReactNode
  className?: string
  variant?: 'primary' | 'ghost' | 'solidWhatsApp'
  prefill?: PrefillKey
}
